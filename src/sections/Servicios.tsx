...
import {
  ...
  Layers, Server, Cpu, Microscope, Wrench,
  Bot, FileCode, Workflow, Database,
...
const services: Service[] = [
  ...
  // === HARDWARE (reducido) ===
  {
    ...
    description: "Limpieza completa de ventiladores, disipador, placa base y componentes. Eliminación de polvo acumulado que causa sobrecalentamiento y ruido. No se cambia ni repone ninguna pieza.",
    price: "Desde 2.000 CUP",
    tag: "hardware",
  },
  {
    ...
    description: "Identificación de piezas defectuosas (RAM, GPU, placa, CPU). Pruebas por eliminación. Te digo qué cambiar y dónde conseguirlo. No reparo, solo diagnostico.",
    price: "Desde 1.500 CUP",
    tag: "hardware",
  },
  {
    icon: Wrench,
    name: "Armado de PC (mano de obra)",
    description: "Ensamblaje completo de PC a partir de componentes que traigas tú. Instalación de placa, CPU, RAM, GPU, discos, fuente y cableado ordenado. Solo cobro mano de obra.",
    price: "Desde 4.000 CUP",
    tag: "hardware",
  },
]
...
const categoryConfig = {
  ...
  hardware: {
    ...
    description: "Reparación y mantenimiento de hardware de PC (sin repuestos)",
    color: "orange",
