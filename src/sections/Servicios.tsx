        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6 animate-stagger">
          {services.map((service, index) => {
            ...
            return (
              <div
                key={index}
                className="group bg-[#121820] border border-[#1E2D3D] rounded-xl p-8 hover:border-[rgba(23,147,209,0.3)] hover:shadow-glow transition-all duration-250 cursor-default relative overflow-hidden"
              >
                {/* Top accent line */}
