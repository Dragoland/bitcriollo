...
const services: Service[] = [
  ...
  { id: "impresora", icon: Printer, name: "Configuración de impresoras", description: "Instalación de drivers, configuración en red, resolución de errores de impresión. Sin abrir la impresora.", tag: "software" },
  { id: "wifi", icon: Wifi, name: "Configuración de WiFi y routers", description: "Cambio de contraseña, mejora de cobertura, solución de desconexiones. Solo configuración, no cableado.", tag: "software" },
  { id: "smarttv", icon: Tv, name: "Configuración de Smart TV", description: "Instalación de apps, configuración de streaming, conexión con celular, resolución de errores.", tag: "software" },
  { id: "seguridad", icon: Lock, name: "Asesoría en seguridad digital", description: "Cómo evitar estafas por WhatsApp, navegación segura, backups automáticos, protección de tus datos personales.", tag: "software" },
  { id: "compra", icon: ShoppingCart, name: "Asesoría para compra de equipos", description: "Te quieren vender una PC vieja como nueva? Te digo qué vale la pena y qué es una estafa antes de que pagues.", tag: "software" },
  { id: "pendrive", icon: Usb, name: "Creación de pendrives booteables", description: "Linux, Windows, herramientas de recuperación. Te preparo el pendrive para que puedas arreglar tu PC tú mismo después.", tag: "software" },
  { id: "digitalizar", icon: FileText, name: "Digitalización de documentos", description: "Escaneo, conversión a PDF, compresión, organización de archivos. Ideal para trámites y papeleo.", tag: "software" },
  { id: "servidor", icon: Server, name: "Configuración de servidor local / NAS", description: "Montaje de servidor de archivos, multimedia o backups en tu red local con Linux. Ideal para compartir en casa o negocio.", tag: "software" },
  { id: "diseno", icon: Palette, name: "Diseño gráfico", description: "Flyers, posters, tarjetas de presentación, logos, invitaciones, menús para negocios, diplomas y certificados.", tag: "design" },
  { id: "fotos", icon: Image, name: "Edición y retoque de fotos", description: "Corrección de color, eliminación de objetos, mejoras de iluminación, collages, montajes fotográficos.", tag: "design" },
  { id: "cv", icon: FileUser, name: "Creación de currículums digitales", description: "CV profesional en PDF, cartas de presentación, portafolios simples. Para que te veas bien sin gastar fortuna.", tag: "design" },
  { id: "video", icon: Video, name: "Conversión y compresión de videos", description: "MP4, AVI, MKV. Reduzco el tamaño para que quepa en WhatsApp o USB sin perder calidad visible.", tag: "media" },
  { id: "emuladores", icon: Gamepad2, name: "Instalación de emuladores y juegos retro", description: "Configuro emuladores de consolas clásicas en tu PC o celular. Revive los juegos de tu infancia.", tag: "media" },
  { id: "scripts", icon: Code, name: "Desarrollo y automatización", description: "Scripts en Python, utilidades personalizadas, automatización de tareas repetitivas. Cotizo según complejidad.", tag: "remote" },
  { id: "remoto", icon: Globe, name: "Soporte técnico remoto", description: "Para clientes fuera del pueblo: resolución de problemas en Linux y Windows vía conexión remota cuando el internet lo permita.", tag: "remote" },
]
            ...
            return (
              ...
              >
                ...
                <div className="pl-[60px]">
                  <span className={`inline-block px-3 py-1 text-[11px] font-semibold uppercase tracking-wider border rounded ${tagStyles[service.tag]}`}>
